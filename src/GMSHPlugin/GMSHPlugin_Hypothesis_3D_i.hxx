...
//
#ifndef _GMSHPlugin_Hypothesis_3D_i_HXX_
#define _GMSHPlugin_Hypothesis_3D_i_HXX_
...
#include "GMSHPlugin_Hypothesis_3D.hxx"

class SMESH_Gen;

// GMSHPlugin parameters hypothesis (2D case)

class GMSHPLUGIN_EXPORT  GMSHPlugin_Hypothesis_3D_i:
  ...
  public GMSHPlugin_Hypothesis_i
{
 public:
  ...
  // Destructor
  virtual ~GMSHPlugin_Hypothesis_3D_i();
